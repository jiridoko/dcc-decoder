...
if __name__ == "__main__":
    ...
    c.send(loco_speed_advanced(address=47, speed=56, emergency_stop=False, forward=True))
    time.sleep(5)
    c.send(loco_speed_advanced(address=47, speed=37, emergency_stop=False, forward=True))
    time.sleep(5)
    c.send(loco_speed_advanced(address=47, speed=0, emergency_stop=False, forward=True))
